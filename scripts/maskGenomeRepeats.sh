...
ASSEMBLER="flye miniasm masurca-flye masurca-cabog"
...
if [ ! -e $REFPROT ]
	then echo "ERROR: Can't access REFPROT file"
	exit 1
fi
...
for i in $ASSEMBLER
	...
	sed -i --follow-symlinks 's/_pilon_pilon_pilon_pilon_pilon//' 3_assembly.fa
