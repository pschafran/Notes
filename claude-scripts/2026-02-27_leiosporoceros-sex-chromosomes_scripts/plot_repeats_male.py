"""
Repeat composition visualization for LedusM (Leiosporoceros dussii male)
...
group_map = [
    ...
    ('DNA transposons', ['DNA/DTM', 'DNA/DTC', 'DNA/Helitron', 'DNA/DTT', 'DNA/DTH', 'DNA/DTA', 'TIR/Tc1_Mariner']),
    ('LINE', ['LINE/unknown']),
...
# ── Title & save ────────────────────────────────────────────────────────────
fig.text(0.5, 0.995,
         'Leiosporoceros dussii male (LedusM)  —  Repetitive element composition',
