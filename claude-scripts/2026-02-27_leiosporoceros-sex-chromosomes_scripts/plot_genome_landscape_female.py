"""
Genome landscape: protein-coding genes + repeats for LedusF
...
GTF   = 'LedusF_gene_annotations.gtf'
FASTA = 'LedusF_genome.fasta'
OUT   = 'LedusF_genome_landscape'
...
ORDERED_CLASSES = [
    ...
    'LINE/unknown', 'MITE/DTM', 'MITE/DTH', 'MITE/DTC',
...
# Scaffold highlight colours (S3 = sex chromosome)
SCAF_PALETTE = ['#7396b8', '#7396b8', '#b87070', '#7396b8', '#7396b8']
...
merged_union  = {}   # seqid -> merged list of gene ∪ all repeats
...
# Stack layer order (bottom → top): gene_only | unannotated | LTR | DNA | LINE | MITE | para | Unknown
...
fig1.text(0.5, 0.960,
          'Leiosporoceros dussii female (LedusF)  —  Genome landscape',
...
fig2.text(0.5, 0.975,
          'Leiosporoceros dussii female (LedusF)  —  Gene and repeat summary',
