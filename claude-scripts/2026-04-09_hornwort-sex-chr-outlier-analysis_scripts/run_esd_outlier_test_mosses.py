...
chromosomes in moss genome composition statistics.
...
BASE           = "/media/data/projects/hornwort_sex_chromosomes/analysis/moss_genomes"
...
def find_species_tsvs():
    ...
    Handles Ceratodon purpureus specially (separate GG1 / R40 files).
    """
    species = {}
    for d in sorted(os.listdir(BASE)):
        ...
        # Ceratodon: GG1 (includes U) and R40 (V only) analysed separately
        for label, fname in [('Ceratodon_purpureus_GG1', 'CpurpureusGG1_composition_stats.tsv'),
                              ('Ceratodon_purpureus_R40', 'CpurpureusR40_composition_stats.tsv')]:
