"""
Genome landscape: protein-coding genes + repeats + CpG methylation for PaproF
...
BASE       = '/media/data/projects/hornwort_sex_chromosomes/analysis/Paraphymatoceros_proskaueri/Papro252-9.2.2/final_genome_prep'
GFF        = f'{BASE}/pilon.3_renamed.fasta.mod.EDTA.TEanno.gff3'
GTF        = f'{BASE}/braker_renamed.gtf'
FASTA      = f'{BASE}/pilon.3_renamed.fasta'
METHYL_BED = f'{BASE}/../methylation/PaproF_genome.5mCG_5hmCG.bed'
OUT        = f'{BASE}/PaproF_genome_landscape'

SCAFFOLDS = ['PaproF.S1', 'PaproF.S2', 'PaproF.S3', 'PaproF.S4', 'PaproF.S5']
SLABELS   = ['S1', 'S2', 'S3', 'S4', 'S5']
SEX_CHR   = 'PaproF.S5'   # U chromosome
...
fig1.text(0.5, 0.960,
          'Paraphymatoceros proskaueri female (PaproF)  —  Genome landscape',
...
fig2.text(0.5, 0.975,
          'Paraphymatoceros proskaueri female (PaproF)  —  Gene, repeat and methylation summary',
