"""
Repeat composition visualization for PhphyF (Phymatoceros phymatodes female)
...
# ── Paths ──────────────────────────────────────────────────────────────────
BASE  = '/media/data/projects/hornwort_sex_chromosomes/analysis/Phymatoceros_phymatodes/Phymato_6/final_genome_prep'
GFF   = f'{BASE}/PhphyF_repeat_annotations.gff'
FASTA = f'{BASE}/PhphyF_genome.fasta'
OUT   = f'{BASE}/PhphyF_repeat_composition'
...
ORDERED_CLASSES = [
    ...
    'TIR/Tc1_Mariner', 'TIR/Sola2', 'TIR/PiggyBac',
    'LINE/unknown', 'Penelope',
    'MITE/DTM', 'MITE/DTH', 'MITE/DTC', 'MITE/DTA',
    'pararetrovirus',
    'Unknown',
]

MAJOR_ORDER  = ['LTR', 'DNA', 'LINE', 'MITE', 'pararetrovirus', 'Unknown']
SCAFFOLDS    = ['PhphyF.S1', 'PhphyF.S2', 'PhphyF.S3', 'PhphyF.S4', 'PhphyF.S5']
SLABELS      = ['S1\n(48.8 Mb)', 'S2\n(44.4 Mb)', 'S3\n(37.0 Mb)', 'S4\n(34.8 Mb)', 'S5\n(4.9 Mb)']
SEX_CHR      = 'PhphyF.S5'   # U chromosome
...
group_map = [
    ...
    ('DNA transposons', ['DNA/DTM', 'DNA/DTC', 'DNA/Helitron', 'DNA/DTT', 'DNA/DTH', 'DNA/DTA',
                         'TIR/Tc1_Mariner', 'TIR/Sola2', 'TIR/PiggyBac']),
    ('LINE', ['LINE/unknown', 'Penelope']),
    ('MITE', ['MITE/DTM', 'MITE/DTH', 'MITE/DTC', 'MITE/DTA']),
...
# ── Title & save ────────────────────────────────────────────────────────────
fig.text(0.5, 0.995,
         'Phymatoceros phymatodes female (PhphyF)  —  Repetitive element composition',
