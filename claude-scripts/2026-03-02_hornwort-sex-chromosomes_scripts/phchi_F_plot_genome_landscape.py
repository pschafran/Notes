"""
Genome landscape: protein-coding genes + repeats for PhchiF (Phaeomegaceros chiloensis female)
...
BASE  = '/media/data/projects/hornwort_sex_chromosomes/analysis/Phaeomegaceros_fimbriatus/Phaeomegaceros_14765-5/final_genome_prep'
GFF   = f'{BASE}/PhchiF_genome.fasta.mod.EDTA.TEanno.gff3'
GTF   = f'{BASE}/PhchiF_gene_annotations.gtf'
FASTA = f'{BASE}/PhchiF_genome.fasta'
OUT   = f'{BASE}/PhchiF_genome_landscape'

SCAFFOLDS = ['PhchiF.S1', 'PhchiF.S2', 'PhchiF.S3', 'PhchiF.S4',
             'PhchiF.S5', 'PhchiF.S6', 'PhchiF.S7']
SLABELS   = ['S1', 'S2', 'S3', 'S4', 'S5', 'S6', 'S7']
SEX_CHR   = 'PhchiF.S4'   # U chromosome
...
# S4 highlighted as U chromosome (index 3)
SCAF_PALETTE = ['#7396b8', '#7396b8', '#7396b8', '#b87070',
                '#7396b8', '#7396b8', '#7396b8']

WIN_SCAF_COL = {
    'PhchiF.S1': '#5f8ab0',
    'PhchiF.S2': '#7396b8',
    'PhchiF.S3': '#8aaac8',
    'PhchiF.S4': '#b87070',   # U chromosome
    'PhchiF.S5': '#7396b8',
    'PhchiF.S6': '#6888aa',
    'PhchiF.S7': '#8aaac8',
}
...
for i, seqid in enumerate(SCAFFOLDS):
    ...
    sex_note = '   [U chromosome]' if is_sex else ''
...
axs[0].legend(handles=legend_patches, fontsize=7.5, ncol=4,
              ...
              bbox_to_anchor=(0.5, 1.68))

fig1.text(0.5, 0.960,
          'Phaeomegaceros chiloensis female (PhchiF)  —  Genome landscape',
...
fig2.text(0.5, 0.975,
          'Phaeomegaceros chiloensis female (PhchiF)  —  Gene and repeat summary',
