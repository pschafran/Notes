"""
Genome landscape: protein-coding genes + repeats for PhphyF (Phymatoceros phymatodes female)
...
OUT   = f'{BASE}/PhphyF_genome_landscape'
...
# S5 highlighted as U chromosome (index 4)
...
fig1.text(0.5, 0.960,
          'Phymatoceros phymatodes female (PhphyF)  —  Genome landscape',
...
fig2.text(0.5, 0.975,
          'Phymatoceros phymatodes female (PhphyF)  —  Gene and repeat summary',
